...
#bib <- RefManageR::ReadBib(paste0(rprojroot::find_rstudio_root_file(),'man_bib.bib'))
```
# `r metad$toc$sec2$nmn`
# `r metad$toc$sec3$nmn`
# `r metad$toc$sec4$nmn`
# `r metad$toc$sec5$nmn`
...
p1 <- paste0(rprojroot::find_rstudio_root_file(),'/inst/pngs/ss.png')
...
p3 <- paste0(rprojroot::find_rstudio_root_file(),'/inst/pngs/manifold.png')
...
pr2n <- paste0(rprojroot::find_rstudio_root_file(),'/inst/pngs/r2n.png')
knitr::include_graphics(c(pr2n))
```

 - Hybrid form
```{r, echo=F, out.width="40%", fig.cap=""}
pr2h <- paste0(rprojroot::find_rstudio_root_file(),'/inst/pngs/r2h.png')
